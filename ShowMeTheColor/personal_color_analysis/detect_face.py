...
class DetectFace:
    def __init__(self, image):
        ...
        self.predictor = dlib.shape_predictor('/home/bryan/PycharmProjects/test/ShowMeTheColor/res/shape_predictor_68_face_landmarks.dat')
    ...
    def detect_face_part(self):
        ...
        # print('아이템', face_utils.FACIAL_LANDMARKS_IDXS.items())
